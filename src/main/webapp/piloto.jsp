...
<body>
    <%
        ...
        PilotoService pilotoSvc = new PilotoService(pool.getConnection());
        ArrayList<Piloto> pilotos = pilotoSvc.requestAll("codigo ASC");

        PilotoView pilotoview = new PilotoView(pilotos, user);
        out.print(pilotoview);
    %>
